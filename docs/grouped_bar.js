var filename = document.getElementById("grouped").getAttribute("filename")
...
//Create bars
d3.csv(filename, 
function(d) {return {CATEGORY:d.CATEGORY, GROUP:d.GROUP, AREA:d.AREA, VAL:parseFloat(d.VALUE)}}, 
